...
# 📦 URL cruda del archivo R-11.py en GitHub (rama master)
url = "https://raw.githubusercontent.com/marlonblandon/practica_PyEz/master/R-11.py"

# 📁 Carpeta donde guardarás el archivo
destino = os.path.expanduser("~/R-11")
archivo = "R-11.py"
...
if respuesta.status_code == 200:
    ...
    print("⚙ Ejecutando el script sobre el router R-11...")
