...
# 📦 URL cruda del archivo R-9.py en GitHub (rama master)
url = "https://raw.githubusercontent.com/marlonblandon/practica_PyEz/master/R-9.py"

# 📁 Carpeta donde guardarás el archivo
destino = os.path.expanduser("~/R-9")
archivo = "R-9.py"
...
if respuesta.status_code == 200:
    ...
    print("⚙ Ejecutando el script sobre el router R-9...")
