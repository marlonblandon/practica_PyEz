...
# 📦 URL cruda del archivo R-4.py en GitHub (rama master)
url = "https://raw.githubusercontent.com/marlonblandon/practica_PyEz/master/R-4.py"

# 📁 Carpeta donde guardarás el archivo
destino = os.path.expanduser("~/R-4")
archivo = "R-4.py"
...
if respuesta.status_code == 200:
    ...
    print("⚙ Ejecutando el script sobre el router R-4...")
